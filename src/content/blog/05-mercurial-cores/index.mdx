...
At a glance, I think the implications of this issue is quite serious. Data can be rendered permanently
...
So now I'm wondering why this issue hasn't caused major problems in the industry yet.
Though it has caused problems in Google's system, such as:
